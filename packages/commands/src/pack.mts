 ...
 * @Return {SolutionInfo} 
 */
export async function readSolutionInfo( solutionPath:string ) {
  ...
  const parseElement = ( elementTag: string, regexp: RegExp ) => {
 ...
 */
const getImportSolutionPath = async ( solutionPath:string, packageType:string ): Promise<string> => {
